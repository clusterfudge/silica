...
class TestCompactionValidation(unittest.TestCase):
    ...
    def test_invalid_role(self):
        ...
        error_messages = [i.message for i in report.issues if i.level == ValidationLevel.ERROR]
    ...
    def test_non_alternating_messages(self):
        ...
        warning_messages = [i.message for i in report.issues if i.level == ValidationLevel.WARNING]
    ...
    def test_incomplete_tool_use_last_message(self):
        ...
        info_messages = [i.message for i in report.issues if i.level == ValidationLevel.INFO]
    ...
    def test_compacted_messages_validation(self):
        ...
        report = validate_compacted_messages(compacted_messages, original_messages, preserved_turns=2)
    ...
    def test_api_compatibility_must_start_with_user(self):
        ...
        messages = [
            {"role": "assistant", "content": "Hello!"},  # Invalid - can't start with assistant
        ...
        error_messages = [i.message for i in report.issues if i.level == ValidationLevel.ERROR]
        self.assertTrue(any("must start with a user message" in msg for msg in error_messages))
