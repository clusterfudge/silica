...
class TestCommandIntegrationSafety:
    ...
    def test_setup_command_dry_run(
        ...
        with patch('silica.cli.commands.workspace_environment.get_agent_config_dict') as mock_agent_config:
            mock_agent_config.return_value = {
                'name': 'hdev',
                'description': 'Test agent',
                'install': {'check_command': 'echo test'},
            ...
            with patch('silica.cli.commands.workspace_environment.install_agent') as mock_install:
                mock_install.return_value = True
                
                with patch('silica.cli.commands.workspace_environment.check_environment_variables') as mock_check_env:
                    mock_check_env.return_value = (True, [], [])
                    
                    with patch('silica.cli.commands.workspace_environment.setup_code_directory'):
